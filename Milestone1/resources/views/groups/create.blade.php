                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" name="name" type="text" class="form-control @error('name') border border-danger @enderror" value="{{ old('name') }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="bio" name="bio" class="form-control @error('name') border border danger @enderror" rows="5">{{ old('bio') }}</textarea>
                            ...
                            <div class="form-group row">
                                <label for="profileImage" class="col-md-4 col-form-label text-md-right @error('profileImage') text-danger @enderror">Profile Image</label>
                            ...
                            <div class="form-group row">
                                <label for="bannerImage" class="col-md-4 col-form-label text-md-right @error('bannerImage') text-danger @enderror">Banner Image</label>
